...
const RUNGS: { rung: number; name: string; cost: string; status: string }[] = [
  ...
  {
    rung: 5,
    name: 'Plan güclü / icra zəif',
    cost: 'başçının planı + 1 işçi icrası',
    status: 'işləyir',
  },
...
const PROFILE_HINT: Record<string, string> = {
  ...
  quality:
    'Bütün pillələr. İşçi ilişəndə əvvəlcə başçıdan qısa kömək alınır — çoxaddımlı taskda PLAN (Pillə 5), təkaddımlıda İPUCU (Pillə 4). Tutmasa başçının tam icrası.',
